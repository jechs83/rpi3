...
docker run -d --name proxy1 -e SQUID_PORT=$PROXY1_PORT -p $PROXY1_PORT:$PROXY1_PORT proxy1
...
docker run -d --name proxy2 -e SQUID_PORT=$PROXY2_PORT -p $PROXY2_PORT:$PROXY2_PORT proxy2